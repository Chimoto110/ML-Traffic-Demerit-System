...
const REGISTER_BACKGROUND_IMAGES = [
...
export default function Register() {
  ...
  if (showOtp) {
    return (
      <AuthLayout
        ...
        backgroundImages={REGISTER_BACKGROUND_IMAGES}
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 rounded-xl border border-white/20 bg-slate-900/45 p-4 text-slate-100">
        <div className="text-xs uppercase tracking-wide text-slate-300 font-semibold">Demo Login Credentials</div>
        <div className="mt-2 space-y-1 text-xs text-slate-200">
          <div>Admin: admin@ntsa.go.ke / Admin@123</div>
          <div>Officer: officer@ntsa.go.ke / Officer@123</div>
          <div>Driver: driver@ntsa.go.ke / Driver@123</div>
        </div>
        <div className="mt-2 text-[11px] text-slate-400">Use these on the login page for quick role-based testing.</div>
      </div>
    </AuthLayout>
  );
}

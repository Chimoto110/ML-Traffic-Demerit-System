    ...
    return (
      <div className="fixed inset-0 app-shell ambient-grid flex items-center justify-center">
        <div className="glass-panel px-6 py-5 flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-semibold text-slate-800">Loading workspace</div>
            <div className="text-xs text-slate-500">Preparing your traffic operations console</div>
          </div>
        </div>
      </div>
    );

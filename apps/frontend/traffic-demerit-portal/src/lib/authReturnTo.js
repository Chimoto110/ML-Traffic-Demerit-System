...
export function safeReturnTo() {
  ...
  try {
    ...
    // Strip bootstrap params persisted from URL to localStorage so a crafted
    // returnTo cannot poison the next authenticated session. Normal app-flow
    // params (for example the OAuth consent ctx) are kept.
